  ...
  <?PHP $dao->includeHead('Sales Order',0) ?>
	...
	$(document).ready(function(){
	 ...
	 select:function(event,ui){
		 $.ajax({
	    type:"GET",
		  url:"credit_sale.php?add_cart="+ui.item.value,
		  async:false,
...
$("#entry_date").change(function(){
	$.ajax({
	 type:"GET",
	 url:"credit_sale.php?set_date="+$(this).val(),
	 async:false,
	 success:function(result){}
 });
});
$(".quantity").change(function(){
	...
	$.ajax({
	 type:"GET",
	 url:"credit_sale.php?update_cart="+id+"&quantity="+value+"&total="+totalAmount,
	 success:function(result){
	 }
 });
  ...
  <body class="container">
    ...
    ?>
  	<div id="menu_main">
		 ...
		 <?php if(isset($_SESSION['selectedClient'])){
